...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/session/{sessionId}/group/settings/announce": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/ephemeral": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/join-approval": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/locked": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/member-add-mode": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/name": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/photo/remove": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/photo/set": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/session/{sessionId}/group/settings/topic": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "dto.NewsletterList": {
            ...
            "properties": {
                "count": {
                    "description": "Additional field referenced in handlers",
                    "type": "integer"
                },
                "newsletters": {
                    "type": "array",
        ...
        "dto.SendNewsletterMessageResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/dto.SendNewsletterMessageData"
                },
                "error": {
                    "$ref": "#/definitions/dto.ErrorInfo"
                },
