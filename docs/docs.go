    ...
    "paths": {
        ...
        "/session/{sessionId}/contacts/avatar": {
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get avatar",
                        "schema": {
                            "$ref": "#/definitions/dto.ContactResponse"
                        }
                    }
        ...
        "/session/{sessionId}/group/info": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Group info request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/session/{sessionId}/message/react": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "React to message request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/session/{sessionId}/privacy/find": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Privacy settings query",
                        "name": "request",
                        "in": "body",
                        "schema": {
        ...
        "/session/{sessionId}/privacy/set": {
            "put": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to set privacy settings",
                        "schema": {
                            "$ref": "#/definitions/dto.PrivacySettingsResponse"
                        }
                    }
        ...
        "/session/{sessionId}/webhooks/events": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Supported events list",
                        "schema": {
    ...
    "definitions": {
        ...
        "dto.ChatErrorResponse": {
            ...
            "properties": {
                ...
                "details": {
                    "type": "string",
                    "example": "JID must include domain"
                },
                "message": {
                    "type": "string",
                    "example": "Invalid JID format"
                }
            }
        },
        "dto.ChatResponse": {
        ...
        "dto.CommunityErrorResponse": {
            ...
            "properties": {
                "code": {
                    "type": "string",
                    "example": "COMMUNITY_NOT_FOUND"
                },
                "details": {
                    "type": "string",
                    "example": "Community with JID '120363025246125486@g.us' not found"
                },
                "message": {
                    "type": "string",
        ...
        "dto.CommunityResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/dto.CommunityResponseData"
                },
                "error": {
        ...
        "dto.CommunityResponseData": {
            ...
            "properties": {
                ...
                "community": {
                    "$ref": "#/definitions/dto.CommunityInfo"
                },
                "message": {
                    "type": "string"
                },
        ...
        "dto.NewsletterErrorResponse": {
            ...
            "properties": {
                "code": {
                    "type": "string",
                    "example": "NEWSLETTER_NOT_FOUND"
                },
                "details": {
                    "type": "string",
                    "example": "Newsletter with JID '120363025246125486@newsletter' not found"
                },
                "message": {
                    "type": "string",
        ...
        "dto.SendContactRequest": {
            ...
            "properties": {
                ...
                "contacts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.MessageContactData"
                    }
                },
                "phone": {
                    "type": "string",
        ...
        "dto.SendDocumentRequest": {
            ...
            "properties": {
                "document": {
                    "type": "string",
                    "example": "data:application/pdf;base64,JVBERi0xLjQKJcOkw7zDtsO8"
                },
                "filename": {
                    "type": "string",
                    "example": "document.pdf"
